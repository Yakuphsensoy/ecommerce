                ...
                <div className="loginLeftSide">
                    <div className="leftSideTop">
                        ...
                        <div className="login-signUp">
                            ...
                            <p className="signUpBtn">Üye Ol</p>
                        </div>
                    </div>
                    <div className="nameSurname">
                        <div className="nameInput">
                            <span>Ad</span>
                            <input className="name" type="text" placeholder="Adınız" />
                        </div>
                        <div className="surnameInput">
                            <span>Soyad</span>
                            <input className="surname" type="text" placeholder="Soyadınız" />
                        </div>
                    </div><br />
                    <div className="mail-passwordSignUp">
                        ...
                        <div className="telNumber">
                            ...
                            <input className="tel" type="text" placeholder="0 (53_) ___ __ __" />
                        </div>
                        ...
                        <div className="personalData">
                            ...
                            <p id="data" name="data">Kişisel verileriniz, Aydınlatma Metni kapsamında işlenmektedir. “Üye ol” veya “Sosyal Hesap” butonlarından birine basarak <a href="#">Üyelik Sözleşmesi</a>’ni,
                                <a href="#">Rıza Metni</a>’ni, <a href="#">Çerez Politikası</a>’nı okuduğunuzu ve kabul ettiğinizi onaylıyorsunuz.</p>
                        </div>
                        <br />
                        <div className="loginClick">
                            <button className="loginClick" onClick={() => navigate("/")}><p>Üye Ol</p></button>
